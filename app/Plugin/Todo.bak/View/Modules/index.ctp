...
<? #if($this->Site->can("add", "")) { ?>
	<?= $this->Html->add("Add Module", array("action"=>"edit"),array("class"=>"btn btn-success")); ?>
<? #} ?>
<? $this->end(); ?>
<div class="modules index">
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($modules as $module) { ?>
					<tr>
						<td><?php echo $this->Html->link($module['Module']['title'], array('action'=>'edit',$module['Module']['id'])); ?>&nbsp;</td>
