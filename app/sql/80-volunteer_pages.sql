DROP TABLE IF EXISTS rescue_volunteer_overviews;
CREATE TABLE IF NOT EXISTS rescue_volunteer_overviews
(
...
DROP TABLE IF EXISTS rescue_volunteer_pages;
CREATE TABLE IF NOT EXISTS rescue_volunteer_pages
(
	id INTEGER UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
	site_id INTEGER UNSIGNED,
...
DROP TABLE IF EXISTS rescue_volunteer_downloads;
CREATE TABLE IF NOT EXISTS rescue_volunteer_downloads
(
	id INTEGER UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
DROP TABLE IF EXISTS rescue_volunteer_faqs;
CREATE TABLE IF NOT EXISTS rescue_volunteer_faqs
(
	id INTEGER UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
	site_id INTEGER UNSIGNED NOT NULL,
	ix INTEGER UNSIGNED,
