DROP TABLE IF EXISTS rescue_adoption_overviews;
CREATE TABLE IF NOT EXISTS rescue_adoption_overviews
(
...
DROP TABLE IF EXISTS rescue_adoption_pages;
CREATE TABLE IF NOT EXISTS rescue_adoption_pages
(
	id INTEGER UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
	site_id INTEGER UNSIGNED,
...
DROP TABLE IF EXISTS rescue_adoption_downloads;
CREATE TABLE IF NOT EXISTS rescue_adoption_downloads
(
	id INTEGER UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
DROP TABLE IF EXISTS rescue_adoption_faqs;
CREATE TABLE IF NOT EXISTS rescue_adoption_faqs
(
	id INTEGER UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
	site_id INTEGER UNSIGNED NOT NULL,
	ix INTEGER UNSIGNED,
