...
<? if($this->Html->can_edit($fosterPage['FosterPage'])) { ?>
...
<div class=''>
<? if($this->Html->can_edit($fosterPage['FosterPage'])) { # By default, only owner can add sub fosterPage - and then can re-assign ?>
	<div class='right'>
