...
<div class='<?= empty($form_link) ? "col-md-12" : "col-md-6" ?> margintop25'>
	...
	<div class='margintop25'>
		<!-- customize link -->
		<? if(!empty($form_link)) { ?>
			<?= $this->Html->link("Fill out our online $type form", array('controller'=>Inflector::pluralize(!empty($person)?$person:"rescue_$type"),'action'=>'add'), array('class'=>'btn btn-warning white')); ?>
		<? } ?>
		<? if(empty($form_link)) { ?>
