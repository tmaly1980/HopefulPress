<script>$.dialogtitle('Adoption Form - <?= $adoptable['Adoptable']['name'] ?>');</script>
<div class='view'>

<?= $this->Form->create("AdoptionRequest",array('class'=>'condensed')); ?>
		<p>Interested in adopting <?= $adoptable['Adoptable']['name'] ?>? Contact us via the form below:
