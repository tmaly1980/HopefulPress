...
<div class='row'>
	<div class='col-md-6'>
		<?= $this->Html->image(!empty($imgid)?array('controller'=>'adoptable_photos','action'=>'image',$imgid,'rescue'=>$rescuename):"/images/nophoto.png",array('class'=>'width100p maxheight500')); ?>
