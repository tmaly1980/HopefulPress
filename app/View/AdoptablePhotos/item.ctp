...
<div id="AdoptablePhoto_<?= $photo['id'] ?>" class='Photo col-md-3 height130 center_align'>
...
<? if(!empty($this->request->data['Adoptable']) && $this->Html->me()) { ?>
	<div style='position: absolute; top: 5px; right: 5px;' class=''>
		...
		<?= $this->Html->blink("delete", '', array('controller'=>'adoptable_photos','action'=>'delete',$photo['id'],'rescue'=>$rescuename,'ext'=>'json'), array('id'=>'PhotoDelete'.$photo['id'],'class'=>'controls json btn-xs btn-danger', 'confirm'=>'Are you sure you want to remove this photo?','title'=>'Delete this photo','e'=>0)); ?>
	</div>
